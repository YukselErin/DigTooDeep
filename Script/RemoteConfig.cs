...
public class RemoteConfig : MonoBehaviour
{
    ...
    void ApplyRemoteConfig(ConfigResponse configResponse)
    {
        ...
        allowedVersionMin = RemoteConfigService.Instance.appConfig.GetInt("minimiumVersion");
      

        if (int.Parse(Application.version) < allowedVersionMin)
        {
            LobbyListUI.Instance.disableLobbyHooks();
            LobbyManager.Instance.wrongVersionDisable();
        }
